...
echo "----------------------------------------"
echo "1 Estresar CPU"
echo "2 Estresar CPU con varios nucleos"
#echo "X Estresar RAM y CPU"
...
#echo "Ingrese el usuario que va a consumir recursos"
#read user

#sudo -u "$user" python3 ./scripts/ram2.py

#actual=$(pwd)
#su - "$user" -c "python3 $actual/scripts/ram2.py"
